  ...
  return (
    <div id="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Password------------------------------------------------- */}
        <div className={message === "Password is required" || message === "Confirm password did not match"? "incorrect" : ""}>
        ...
        {/* Confirm Password------------------------------------------------- */}
        <div className={message === "Confrim password is required"? "incorrect password-wrapper" : message === "Confirm password did not match"? "incorrect" : ""}>
        ...
        {/* Contact Number------------------------------------------------- */}
        <div className={message === "Contact number is required"? "incorrect" : ""}>
